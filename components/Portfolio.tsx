...
export const Portfolio: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-dvh">
      ...
      <div className={`max-w-screen-xl flex flex-wrap items-center justify-between p-4 transition-all transition-transform duration-1000 ${s['nav-bar']} m-4 mx-4 md:mx-auto`}>
        <Link
          href=""
